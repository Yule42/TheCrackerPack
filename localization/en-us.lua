return {
        ...
        Back = {
            ...
            b_cracker_gambler2 = {
                ...
                text = {
                    ...
                    '{C:green}#3# in #4#{} chance to half it instead',
                    '{C:inactive}(Odds cannot change, {C:money}$100{C:inactive} max)',
                }
            },
        },
        Joker = {
    ...
    misc = {
        dictionary = {
            reverse_arcana_pack = 'R-cana Pack',
            reverse_arcana_pack_2 = 'Jumbo R-cana Pack',
            reverse_arcana_pack_3 = 'Mega R-cana Pack',
            k_inactive="inactive",
