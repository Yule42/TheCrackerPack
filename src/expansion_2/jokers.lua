SMODS.Joker{ --Royal Decree
    ...
    attributes = { 'passive', 'hand_type', 'ace', 'face' },
    cost = 6,
    rarity = 2,
...
SMODS.Joker{ --Shrimp Cocktail
    ...
    attributes = { 'discard', 'scaling', 'food' },
    cost = 4,
    rarity = 1,
    blueprint_compat = false,
...
SMODS.Joker{ --Hamburger
    ...
    attributes = { 'passive', 'food', 'hands', 'discard' },
    cost = 8,
    rarity = 3,
    blueprint_compat = false,
    eternal_compat = false,
...
SMODS.Joker{ --High Roller
    ...
    attributes = { 'enhancements', 'xmult', 'scaling', 'reset' },
    cost = 7,
    rarity = 2,
    blueprint_compat = true,
    eternal_compat = true,
...
SMODS.Joker{ --The Falcon
    ...
    attributes = { 'destroy_card', 'discard', 'chance' },
    cost = 6,
    rarity = 2,
    blueprint_compat = true,
    eternal_compat = true,
